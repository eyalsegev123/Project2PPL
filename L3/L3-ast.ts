...
export type ClassExp = {tag: "ClassExp"; fields: VarDecl[]; methods: Binding[];} //Class
...
export const makeLitExp = (val: SExpValue): LitExp =>
    ({tag: "LitExp", val: val});
export const makeClassExp = (fields: VarDecl[], methods: Binding[]): ClassExp => //Class
    ({tag: "ClassExp", fields, methods});
...
export const isClassExp = (x: any): x is ClassExp => x.tag === "ClassExp"; //Class
